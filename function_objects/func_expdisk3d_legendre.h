/*   Class interface definition for func_expdisk3d_legendre.cpp
 * 
...
// CLASS ExponentialDisk3DLegendre:
...
class ExponentialDisk3DLegendre : public FunctionObject
{
  ...
  private:
    ...
    double DistanceAlongMajorAxis(double xp, double yp);
